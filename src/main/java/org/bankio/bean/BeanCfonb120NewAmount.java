...
public class BeanCfonb120NewAmount {
	...
	public String toString() {
		return "BeanCfonb120NewAmount [typeEnregistrementCode=" + typeEnregistrementCode + ", codeBanque=" + codeBanque
	...
	public String getSoldeDate() {
		return soldeDate;
	}

	public void setSoldeDate(String soldeDate) {

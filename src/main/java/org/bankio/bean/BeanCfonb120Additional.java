...
public class BeanCfonb120Additional {
	...
	private String qualifiantDetail;
	...
	public String getQualifiantDetail() {
		return qualifiantDetail;
	}

	public void setQualifiantDetail(String qualifiantDetail) {
		this.qualifiantDetail = qualifiantDetail;
	}
